...
**"Cannot create account" / Registration fails:**
- Ensure `VITE_API_URL` is set in your frontend Vercel project settings
- Ensure `FRONTEND_URL` is set in your backend to allow CORS
- Check browser console for CORS errors

**CORS Errors:**
- Make sure `FRONTEND_URL` environment variable matches your frontend domain exactly
- For testing, you can temporarily set `CORS_ALLOW_ALL=true` in the backend
