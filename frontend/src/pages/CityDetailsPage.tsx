...
const cityData: Record<string, CityInfo> = {
  'Nairobi': {
    ...
    attractions: [
      { name: 'Nairobi National Park', type: 'Wildlife', rating: 4.8, image: 'https://images.unsplash.com/photo-1612196808214-b8e1d6145a8c?w=400&h=300&fit=crop&q=80', description: 'The only national park within a capital city' },
      { name: 'Giraffe Centre', type: 'Wildlife', rating: 4.7, image: 'https://images.unsplash.com/photo-1534567153574-2b12153a87f0?w=400&h=300&fit=crop&q=80', description: 'Get up close with endangered Rothschild giraffes' },
      { name: 'Karen Blixen Museum', type: 'Museum', rating: 4.5, image: 'https://images.unsplash.com/photo-1489392191049-fc10c97e64b6?w=400&h=300&fit=crop&q=80', description: 'Historic home of the "Out of Africa" author' },
      { name: 'Nairobi National Museum', type: 'Museum', rating: 4.4, image: 'https://images.unsplash.com/photo-1582650949595-e2bf1a2c0a62?w=400&h=300&fit=crop&q=80', description: 'Kenya\'s cultural heritage and natural history' },
    ],
    hotels: [
  ...
  'Mombasa': {
    ...
    attractions: [
      { name: 'Fort Jesus', type: 'Historic', rating: 4.6, image: 'https://images.unsplash.com/photo-1596005554384-d293674c91d7?w=400&h=300&fit=crop&q=80', description: 'UNESCO World Heritage Site, 16th-century Portuguese fort' },
      { name: 'Diani Beach', type: 'Beach', rating: 4.9, image: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=400&h=300&fit=crop&q=80', description: 'Award-winning white sand beach' },
      { name: 'Old Town Mombasa', type: 'Cultural', rating: 4.5, image: 'https://images.unsplash.com/photo-1559128010-7c1ad6e1b6a5?w=400&h=300&fit=crop&q=80', description: 'Historic Swahili architecture and markets' },
      { name: 'Haller Park', type: 'Nature', rating: 4.4, image: 'https://images.unsplash.com/photo-1549366021-9f761d450615?w=400&h=300&fit=crop&q=80', description: 'Wildlife sanctuary with giraffes and hippos' },
    ],
    hotels: [
  ...
  'Kampala': {
    ...
    attractions: [
      { name: 'Kasubi Tombs', type: 'Historic', rating: 4.5, image: 'https://images.unsplash.com/photo-1489392191049-fc10c97e64b6?w=400&h=300&fit=crop&q=80', description: 'UNESCO World Heritage burial grounds of Buganda kings' },
      { name: 'Uganda National Museum', type: 'Museum', rating: 4.3, image: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=400&h=300&fit=crop&q=80', description: 'Uganda\'s cultural and natural heritage' },
      { name: 'Namugongo Martyrs Shrine', type: 'Religious', rating: 4.6, image: 'https://images.unsplash.com/photo-1548625149-fc4a29cf7092?w=400&h=300&fit=crop&q=80', description: 'Important pilgrimage site' },
  ...
  'Kigali': {
    ...
    attractions: [
      { name: 'Kigali Genocide Memorial', type: 'Memorial', rating: 4.9, image: 'https://images.unsplash.com/photo-1580060839134-75a5edca2e99?w=400&h=300&fit=crop&q=80', description: 'Moving tribute to the 1994 genocide victims' },
      { name: 'Inema Arts Center', type: 'Art', rating: 4.6, image: 'https://images.unsplash.com/photo-1578926288207-a90a5366759d?w=400&h=300&fit=crop&q=80', description: 'Contemporary Rwandan art gallery' },
      { name: 'Kimironko Market', type: 'Market', rating: 4.4, image: 'https://images.unsplash.com/photo-1534723452862-4c874018d66d?w=400&h=300&fit=crop&q=80', description: 'Largest local market for crafts and produce' },
      { name: 'Nyamirambo', type: 'Cultural', rating: 4.3, image: 'https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=400&h=300&fit=crop&q=80', description: 'Vibrant Muslim quarter with great nightlife' },
    ],
    hotels: [
  ...
  'Dar es Salaam': {
    ...
    attractions: [
      { name: 'National Museum', type: 'Museum', rating: 4.4, image: 'https://images.unsplash.com/photo-1575223970966-76ae61ee7838?w=400&h=300&fit=crop&q=80', description: 'Tanzania\'s history and archaeology' },
      { name: 'Coco Beach', type: 'Beach', rating: 4.3, image: 'https://images.unsplash.com/photo-1473116763249-2faaef81ccda?w=400&h=300&fit=crop&q=80', description: 'Popular beach for locals and tourists' },
      { name: 'Village Museum', type: 'Cultural', rating: 4.2, image: 'https://images.unsplash.com/photo-1516426122078-c23e76319801?w=400&h=300&fit=crop&q=80', description: 'Traditional Tanzanian village life' },
      { name: 'Kariakoo Market', type: 'Market', rating: 4.1, image: 'https://images.unsplash.com/photo-1488459716781-31db52582fe9?w=400&h=300&fit=crop&q=80', description: 'Bustling local market' },
    ],
    hotels: [
