...
const cityData: Record<string, {
  ...
  'Nairobi': {
    ...
    heroImage: 'https://images.unsplash.com/photo-1611348524140-53c9a25263d6?w=800&h=600&fit=crop&q=80',
    timezone: 'EAT (UTC+3)',
    currency: 'KES',
  ...
  'Kampala': {
    ...
    heroImage: 'https://images.unsplash.com/photo-1596005554384-d293674c91d7?w=800&h=600&fit=crop&q=80',
    timezone: 'EAT (UTC+3)',
    currency: 'UGX',
  ...
  'Kigali': {
    ...
    heroImage: 'https://images.unsplash.com/photo-1580060839134-75a5edca2e99?w=800&h=600&fit=crop&q=80',
    timezone: 'CAT (UTC+2)',
    currency: 'RWF',
  ...
  'Mombasa': {
    ...
    image: 'https://images.unsplash.com/photo-1590523741831-ab7e8b8f9c7f?w=800&h=600&fit=crop&q=80',
    heroImage: 'https://images.unsplash.com/photo-1590523741831-ab7e8b8f9c7f?w=800&h=600&fit=crop&q=80',
    timezone: 'EAT (UTC+3)',
    currency: 'KES',
    language: 'English, Swahili',
    population: '1.2 million',
  ...
  'Dar es Salaam': {
    ...
    heroImage: 'https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=800&h=600&fit=crop&q=80',
    timezone: 'EAT (UTC+3)',
    currency: 'TZS',
    language: 'English, Swahili',
  ...
  'Arusha': {
    ...
    image: 'https://images.unsplash.com/photo-1609198092458-38a293c7ac4b?w=800&h=600&fit=crop&q=80',
    heroImage: 'https://images.unsplash.com/photo-1609198092458-38a293c7ac4b?w=800&h=600&fit=crop&q=80',
    timezone: 'EAT (UTC+3)',
    currency: 'TZS',
    language: 'English, Swahili',
    population: '416,000',
  ...
  'Goma': {
    ...
    heroImage: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=800&h=600&fit=crop&q=80',
    timezone: 'CAT (UTC+2)',
    currency: 'USD/CDF',
  ...
  'Jinja': {
    ...
    heroImage: 'https://images.unsplash.com/photo-1432405972618-c60b0225b8f9?w=800&h=600&fit=crop&q=80',
    timezone: 'EAT (UTC+3)',
    currency: 'UGX',
    language: 'English, Luganda',
    population: '300,000',
  ...
  'Bujumbura': {
    ...
    heroImage: 'https://images.unsplash.com/photo-1505142468610-359e7d316be0?w=800&h=600&fit=crop&q=80',
    timezone: 'CAT (UTC+2)',
    currency: 'BIF',
  ...
  'Gitega': {
    ...
    image: 'https://images.unsplash.com/photo-1523978591478-c753949ff840?w=800&h=600&fit=crop&q=80',
    heroImage: 'https://images.unsplash.com/photo-1523978591478-c753949ff840?w=800&h=600&fit=crop&q=80',
    timezone: 'CAT (UTC+2)',
    currency: 'BIF',
    language: 'French, Kirundi',
    population: '135,000',
