...
const cityData: Record<string, {
  ...
  'Nairobi': {
    ...
    image: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/15/33/fc/f0/nairobi.jpg?w=800&h=600&s=1',
    heroImage: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/15/33/fc/f0/nairobi.jpg?w=1200&h=800&s=1',
    timezone: 'EAT (UTC+3)',
    currency: 'KES',
  ...
  'Kampala': {
    ...
    image: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/17/d4/98/44/uganda-national-mosque.jpg?w=800&h=600&s=1',
    heroImage: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/17/d4/98/44/uganda-national-mosque.jpg?w=1200&h=800&s=1',
    timezone: 'EAT (UTC+3)',
    currency: 'UGX',
  ...
  'Kigali': {
    ...
    image: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/17/e4/f8/d0/kigali-convention-centre.jpg?w=800&h=600&s=1',
    heroImage: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/17/e4/f8/d0/kigali-convention-centre.jpg?w=1200&h=800&s=1',
    timezone: 'CAT (UTC+2)',
    currency: 'RWF',
  ...
  'Mombasa': {
    ...
    image: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/10/a9/e6/f8/fort-jesus.jpg?w=800&h=600&s=1',
    heroImage: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/10/a9/e6/f8/fort-jesus.jpg?w=1200&h=800&s=1',
    timezone: 'EAT (UTC+3)',
    currency: 'KES',
    language: 'English, Swahili',
    population: '1.2 million',
  ...
  'Dar es Salaam': {
    ...
    image: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/15/33/fb/59/dar-es-salaam.jpg?w=800&h=600&s=1',
    heroImage: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/15/33/fb/59/dar-es-salaam.jpg?w=1200&h=800&s=1',
    timezone: 'EAT (UTC+3)',
    currency: 'TZS',
    language: 'English, Swahili',
  ...
  'Arusha': {
    ...
    image: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/10/e8/91/73/mount-meru.jpg?w=800&h=600&s=1',
    heroImage: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/10/e8/91/73/mount-meru.jpg?w=1200&h=800&s=1',
    timezone: 'EAT (UTC+3)',
    currency: 'TZS',
    language: 'English, Swahili',
    population: '416,000',
  ...
  'Goma': {
    ...
    image: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/17/4a/d0/da/nyiragongo-volcano.jpg?w=800&h=600&s=1',
    heroImage: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/17/4a/d0/da/nyiragongo-volcano.jpg?w=1200&h=800&s=1',
    timezone: 'CAT (UTC+2)',
    currency: 'USD/CDF',
  ...
  'Jinja': {
    ...
    image: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0e/a7/c1/e4/source-of-the-nile.jpg?w=800&h=600&s=1',
    heroImage: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0e/a7/c1/e4/source-of-the-nile.jpg?w=1200&h=800&s=1',
    timezone: 'EAT (UTC+3)',
    currency: 'UGX',
    language: 'English, Luganda',
    population: '300,000',
  ...
  'Bujumbura': {
    ...
    image: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/12/3d/2e/95/plage-du-lac-tanganyika.jpg?w=800&h=600&s=1',
    heroImage: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/12/3d/2e/95/plage-du-lac-tanganyika.jpg?w=1200&h=800&s=1',
    timezone: 'CAT (UTC+2)',
    currency: 'BIF',
  ...
  'Gitega': {
    ...
    image: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0d/7b/24/78/musee-national-du-burundi.jpg?w=800&h=600&s=1',
    heroImage: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0d/7b/24/78/musee-national-du-burundi.jpg?w=1200&h=800&s=1',
    timezone: 'CAT (UTC+2)',
    currency: 'BIF',
    language: 'French, Kirundi',
    population: '135,000',
...
const getDefaultCityData = (cityName: string) => ({
  ...
  image: 'https://images.pexels.com/photos/3935702/pexels-photo-3935702.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
  heroImage: 'https://images.pexels.com/photos/3935702/pexels-photo-3935702.jpeg?auto=compress&cs=tinysrgb&w=1920&h=800&fit=crop',
  timezone: 'EAT (UTC+3)',
  currency: 'USD',
